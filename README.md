...
文首配图为未登录前的营销首页（[`public/index.png`](./public/index.png)），便于快速了解产品叙事与版本演进。
...
![演员列表中的动态水位与阈值示意](./public/actress.png)

*（控制台「演员」页：筛选、灯色与水族线一目了然。）*
...
![全局风控大盘](./public/dashboard.png)

*（Dashboard：生态透视、待办与资产动向总览。）*
...
![梯队批量能力：刷新影片数、存储路径导入等](./public/bulkaction.png)

*（梯队相关批量操作与「从存储导入演员」流程示意。）*
